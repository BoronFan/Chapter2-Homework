...
public class Exercise_3_PullParser {
    public static List<Exercise_3_Message> pull2xml(InputStream is) throws Exception {
        List<Exercise_3_Message> list = null;
        Exercise_3_Message msg = null;
        //创建xmlPull解析器
